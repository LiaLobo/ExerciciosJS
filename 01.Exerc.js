...
// Declare uma variável constante com um nome válido. Não é possível declarar const sem dar um valor para ela 
...
alert('Você confirma que ', + name ' é verdadeiro, assim como consta em seu documento?')
